...
public class DeliveryDAO {
    ...
    private static final String GET_ORDER_LISTS_ALL = "SELECT * FROM v_orderlist ORDER BY order_id";
    ...
    /* register */
    private static final String REGISTER_NEW_CUSTOMER = "INSERT INTO customer VALUES (?, ?, sha(?), ?, ?, 'NULL')";
