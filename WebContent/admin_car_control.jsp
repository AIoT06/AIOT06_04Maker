                            ...
                            <div>
                                <table class="ControllPanel">
                                    <tr>
                                        <td></td>
                                        <td>
                                            <input class="F" type="button"
                                                   onclick="motor('F')" value="前">
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <input class="L" type="button"
                                                   onclick="motor('L')" value="左">
                                        </td>
                                        <td id="S">
                                            <input class="S" type="button"
                                                   onclick="motor('S')" value="停">
                                        </td>
                                        <td id="R">
                                            <input class="R" type="button"
                                                   onclick="motor('R')" value="右">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
...
<script>
        function motor(cmd) {
            $.get('http://192.168.50.65:5000/' + cmd, callback);
        }
