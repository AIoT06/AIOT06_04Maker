                                ...
                                <c:forEach items="${customers}" var="customer" varStatus="c">
                                    <tr>
                                        ...
                                        <td><input type="button" value="修改"
                                                   onclick="updateCustomer(${customer.id})"/></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
                            <input type="button" value="新增客戶" onclick="insertForm()"/>
                            <form id="insertForm" method="post" action="AddNewCustomer"></form>
                            <form id="updateCustomer" method="post" action="EditCustomer"></form>
                        </div>
                    </div>
                </div>
