...
<body>
    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container box_1620">
          <a class="navbar-brand logo_h" href="./index.html"><img src="./img/top-b.png" alt=""></a>
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav justify-content-end">
              ...
              <li class="nav-item"><a class="nav-link" href="./chef.html">Team</a>
  ...
  <section class="hero-banner">
    <div class="hero-wrapper">
      <div class="hero-left">
        <h1 class="hero-title">AI自走機器人 </h1>
        <h3 class="hero-subtitle">An Autonomous Delivery Vehicle solution </h3>
      ...
      <div class="hero-right">
        <div class="owl-carousel owl-theme hero-carousel">
          <div class="hero-carousel-item">
            <img class="img-fluid" src="./img/banner/food_delivery.jpg" alt="">
          </div>
          <div class="hero-carousel-item">
            <img class="img-fluid" src="./img/banner/delivery_package.png" alt="">
          </div>
          <div class="hero-carousel-item">
        ...
        <div class="col-md-6 col-xl-6 mb-5 mb-md-0 pb-5 pb-md-0">
          <div class="img-styleBox">
            <div class="styleBox-border">
              <img class="styleBox-img1 img-about" src="./img/home/DonkeyCar.jpg" alt="">
            </div>
            <img class="styleBox-img2 img-about" src="./img/home/about2.jpg" alt="">
          </div>
        </div>
  ...
  <section class="section-margin">
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-3 mb-4 mb-lg-2">
          <div class="chef-card">
            <img class="card-img rounded-0" src="./img/group/秉勳.jpg" alt="">
        ...
        <div class="col-sm-6 col-lg-3  mb-4 mb-lg-2">
          <div class="chef-card">
            <img class="card-img rounded-0" src="./img/group/Jemmy.jpg" alt="">
            <div class="chef-footer">
              <h4>何澤民</h4>
              <p>Donkey Car</p>
            </div>
        ...
        <div class="col-sm-6 col-lg-3 mb-4 mb-lg-2">
          <div class="chef-card">
            <img class="card-img rounded-0" src="./img/group/Angela.jpg" alt="">
            <div class="chef-footer">
              <h4>江盈慧</h4>
              <p>OpenVino</p>
            </div>
        ...
        <div class="col-sm-6 col-lg-3 mb-4 mb-lg-2">
          <div class="chef-card">
            <img class="card-img rounded-0" src="./img/group/Lucas.jpg" alt="">
            <div class="chef-footer">
              <h4>許雅筌</h4>
              <p>OpenVino + Data Base</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-lg-3 mb-4 mb-lg-2">
          <div class="chef-card">
            <img class="card-img rounded-0" src="./img/group/Tracy.jpg" alt="">
            <div class="chef-footer">
              <h4>林思妤</h4>
              <p>UI/ Dashboard</p>
            </div>
        ...
        <div class="col-sm-6 col-lg-3 mb-4 mb-lg-2">
          <div class="chef-card">
            <img class="card-img rounded-0" src="./img/group/聖哲.jpg" alt="">
            <div class="chef-footer">
              <h4>黃聖哲</h4>
              <p>OpenVino + 技術評估</p>
            </div>
        ...
        <div class="col-sm-6 col-lg-3 mb-4 mb-lg-2">
          <div class="chef-card">
            <img class="card-img rounded-0" src="./img/group/振銓.jpg" alt="">
            <div class="chef-footer">
              <h4>李振銓</h4>
              <p>自駕小車基礎架構</p>
            </div>
  ...
  <section class="bg-lightGreen section-padding">
    <div class="container">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
          <div class="card-blog">
            <img class="card-img rounded-0" src="./img/blog/blog.png" alt="">
            <div class="blog-body">
              <ul class="blog-info">
        ...
        <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
          <div class="card-blog">
            <img class="card-img rounded-0" src="./img/blog/starship.jpg" alt="">
            <div class="blog-body">
              <ul class="blog-info">
                <li><a href="#">Admin post</a></li>
                <li><a href="#">Jan 10, 2019</a></li>
        ...
        <div class="col-sm-6 col-lg-4 mb-4 mb-lg-0">
          <div class="card-blog">
            <img class="card-img rounded-0" src="img/blog/blog01.jpg" alt="">
            <div class="blog-body">
              <ul class="blog-info">
                <li><a href="#">Admin post</a></li>
                <li><a href="#">Jan 10, 2019</a></li>
  ...
  <footer class="footer-area section-gap">   
	...
	All rights reserved | This template is made with <i class="ti-heart" aria-hidden="true">
